...
//to compile: mpicc.mpich mpi_reduce_test.c -o mrTest
//to run: time mpirun.mpich -np 4 ./mrTest
//to lazy: mpicc.mpich mpi_reduce_test.c -o mrTest; time mpirun.mpich -np 4 ./mrTest
